...
1. Арендовать VPS (Aeza, Timeweb и т.п.) с локацией за границей (Германия, Нидерланды).
2. Установить Python 3.11+, git.
3. Клонировать репозиторий, создать venv, установить зависимости.
4. Настроить `.env`, положить PDF.
